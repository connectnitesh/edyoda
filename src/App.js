...
function App() {
  ...
  function handlePrice1() {
    setPrice(179);
    const value = 18500-179;
    setOfferPrice(value.toLocaleString());
    setBckg1("#d7eddd");
    setBckg2("#fff");
    setBckg3("#fff");
  }
    ...
    <>
      <nav className="navbar">
        <div className="nav-left">
          <img className="brand" src={logo} width={100} alt="" srcset="" />
          <ul>
            <li>
              <a href="/">
      ...
      <div className="contents">
        <div className="box1">
          ...
          <h2>
            ₹<span className="strike">18500</span> at just <span>₹99</span> per
            year!
          </h2>
          <div className="items">
        ...
        <div className="box2">
          ...
          <div className="pay-s alert" >
            <div className="pay-u">
              <h5>Limited time offer</h5>
              <div style={{ display: "flex" }}>
                <img src={gclk} color="#000" width={19} alt="" srcset="" />
          ...
          <div className="pay-t">
            ...
            <div>
              <h3 style={{fontSize: '1.5rem'}}>{price}</h3>
            </div>
          </div>
